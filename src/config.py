...
class Settings:
    ...
    MAILINGLIST_LIMIT = config("MAILINGLIST_LIMIT")
    TEST_USEREMAIL_1 = config("TEST_USEREMAIL_1")
    TEST_USEREMAIL_2 = config("TEST_USEREMAIL_2")
    TEST_USEREMAIL_3 = config("TEST_USEREMAIL_3")
    TEST_USEREMAIL_4 = config("TEST_USEREMAIL_4")
    TEST_USEREMAIL_5 = config("TEST_USEREMAIL_5")
    TEST_USEREMAIL_6 = config("TEST_USEREMAIL_6")
    TEST_USEREMAIL_7 = config("TEST_USEREMAIL_7")
    TEST_USEREMAIL_8 = config("TEST_USEREMAIL_8")
    TEST_USEREMAIL_9 = config("TEST_USEREMAIL_9")
    TEST_USEREMAIL_10 = config("TEST_USEREMAIL_10")
